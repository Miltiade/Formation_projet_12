...
def __init__(self, id: int, username: str, email:str, password: str, department: Department):
    ...
    self.email = email
    self.__password = password  # name-mangled: _Collaborator__password
...
def verify_password(self, candidate: str) -> bool:
    """Check a candidate password hash using constant-time comparison."""
    return hmac.compare_digest(candidate, self.__password)
